...
suspect_words = [
  ...
  (0.2, 'have it on film'),
  (0.2, 'have it on a recording'),
  (1.0, 'have video proof'),
  (1.0, 'have audio proof'),
  (0.8, 'saved screenshots as proof'),
  (0.8, 'saved screenshots as evidence'),
...
violated_words = [
  ...
  (0.1, 'aided someone in killing her baby, violating'),
  (0.1, 'aided someone in killing her child, violating'),
  (0.1, 'aided someone in killing her baby, disobeying'),
  (0.1, 'aided someone in killing her child, disobeying'),
  ...
  (0.1, 'aided someone in killing her baby, breaking'),
  (0.1, 'aided someone in killing her child, breaking'),
  ...
  (0.1, 'aided someone in killing her baby, in violation of'),
  (0.1, 'aided someone in killing her child, in violation of'),
  ...
  (0.1, 'aided someone in killing her baby and violated'),
  (0.1, 'aided someone in killing her child and violated'),
]
days_of_the_week = [
  'Sunday',
  'Monday',
